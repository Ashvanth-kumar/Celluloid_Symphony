    ...
    <footer className="text-white bg-gray-800">
      <div className="flex flex-wrap py-8">
        ...
        >
          ...
          <p className="text-gray-400 mt-3 leading-relaxed">
            P -585/1 Indhra Nagar ,AnnaNagar,
            <br />
            MAdurai - 625020
          </p>
        </div>
        ...
        >
          ...
          <p className="text-gray-400 mt-3">
            ...
            <div className="flex items-center">
              ...
              <a
                href="mailto:22pw06@psgtech.ac.in"
                className="text-white hover:text-green-400"
              >
          ...
          <ul className="flex my-4">
            <li className="p-2 bg-gray-700 rounded mx-1 hover:bg-green-500 transition">
              <a
                ...
                href="https://www.linkedin.com/in/ashvanth-kumar/"
              >
                <svg
                  fill="currentColor"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <li className="p-2 bg-gray-700 rounded mx-1 hover:bg-green-500 transition">
              <a className="text-white" href="https://github.com/Ashvanth-kumar">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-5 h-5"
                  viewBox="0 0 24 24"
